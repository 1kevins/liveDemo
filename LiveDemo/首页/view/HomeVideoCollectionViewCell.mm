...
-(void)setModel:(FanModelDetail *)Model
{
 
    [_videoCoverImageView sd_setImageWithURL:[NSURL URLWithString:Model.bigpic] placeholderImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"usericon02" ofType:@"png"]]];
    [_iconImgView sd_setImageWithURL:[NSURL URLWithString:Model.smallpic] placeholderImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"usericon02" ofType:@"png"]]];
    _locationLabel.text = (Model.gps.length > 0)?Model.gps:@"中国";
//    _nickeNameLabel.text = DataModel.nickname;
    [self toSetUpThree_dimensionalShadows:_nickeNameLabel andString:Model.myname];
    
//    _comment_countLabel.text = DataModel.comment_count;
    [self toSetUpThree_dimensionalShadows:_comment_countLabel andString:Model.myname];
    
//    _titleLabel.text = DataModel.title;
    [self toSetUpThree_dimensionalShadows:_titleLabel andString:Model.myname];
}
